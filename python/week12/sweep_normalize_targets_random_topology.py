...
from src.network_generators import generate_random_fixed_indegree_ei_network
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Sweep normalization targets on the fixed-indegree random E/I topology."
    )
    parser.add_argument(
        "--max-workers",
        type=int,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(__file__).resolve().parent / "week12_normalize_target_random_topology_sweep.csv",
